                ...
                <div className="mt-5">
                  <ul className="list-inline">
                    <li className="list-inline-item">
                      <Link to='/'>
                        <i className="fa fa-instagram fa-lg text-secondary coding" aria-hidden="true"></i>
                      </Link>
                    </li>
                    <li className="list-inline-item">
                      <Link to='/'>
                        <i className="fa fa-facebook fa-lg text-secondary coding" aria-hidden="true"></i>
                      </Link>
                    </li>
                    <li className="list-inline-item">
                      <Link to='/'>
                        <i className="fa fa-google fa-lg text-secondary coding" aria-hidden="true"></i>
                      </Link>
                    </li>
                    <li className="list-inline-item">
                      <Link to='/'>
                         <i className="fa fa-apple fa-lg text-secondary coding" aria-hidden="true"></i>
                      </Link>
                    </li>
                  </ul>
                </div>
