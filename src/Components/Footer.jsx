...
function Footer() {
  return (
    <div className='container mt-3'>
      <div className="row setInMediaUpDown">
        <div className="col z-media d-flex justify-content-end">
          <img className='mt-2 mb-2 clrCss' src={Help} alt="error" />
        </div>
      ...
      <div className="col-md-1"></div>
        <div className="col-md-4 mt-3 ">
          <div className="col mt-4 clrWhites media text-center">
            <h4 className='clrWhites onmediaBgChange'>INFORMATION</h4>
          </div>
          <div className="float-Left forFlexColumndir">
            <div className="col mt-2 clrWhites centerStarmedia text-center">
        ...
        <div className="col-md-6 mb-4 m-auto">
          <div className="col mt-4 clrWhites centerStarmedia text-center">
