...
const Product = ({ showProductPage,SetCart }) => {
    const {name, imag, price, category , description} = showProductPage;
            ...
            <div className='container'>
                ...
                <div className="row">
                    ...
                    <div className="col p-3 bg-dark text-white ">
                        <h5 className="card-title">{Productname.toUpperCase()}&nbsp;({category.toUpperCase()})</h5>
                        ...
                        <div className='productFlexButton'>
                            <button onClick={SetCart} className="btn btn-warning col-md-4 mb-2 mx-auto myChange text-center">ADD CART</button>
